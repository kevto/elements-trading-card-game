...
public class CardPane extends StackPane {
    ...
    public Pane CreateCard(Card card) {
        ...
        //Load all images
        Image elementImage = new Image("com/elementstcg/client/gui/images/icon_" + card.getElement().name() + ".png");
        Image cardImage = new Image("com/elementstcg/client/gui/images/card_template_lvl" + (card.getCapacityPoints()) + ".png");
