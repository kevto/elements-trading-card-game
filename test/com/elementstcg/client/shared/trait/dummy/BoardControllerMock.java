...
public class BoardControllerMock implements ControlledScreen {

    private Board board;

    public HBox hboxPlayerHand;
    public Pane ghostPane;
    public BorderPane bPaneField;
    public Pane mainPane;

    public Button nextTurnButton;

    public String labelEnemyCAP;
    public String labelPlayerCAP;

    public String labelEnemyDeckSize;
    public String labelPlayerDeckSize;

    public String labelEnemyHP;
    public String labelPlayerHP;

    public Button btSendMessage;
    public ListView chatBox;
    public TextField chatField;

    public String labelEnemyName;
    public String labelPlayerName;


    @FXML
    public Pane enemyInfo;
    ...
    public BoardControllerMock() {
        board = new Board();
        playerField = new FieldGrid(847, 253, 2, 6, null, FieldType.Player);
        enemyField = new FieldGrid(847, 253, 2, 6, null, FieldType.Enemy);
    }
    ...
    public void PutCardPlayer(Card card, int point) {
        playerField.getChildren().get((point > 5 ? point - 10 + 6 : point));
    ...
    public void updatePlayerHP(int hp) {
        ...
        labelPlayerHP = ("" + board.getPlayer().getHp());
    }
...
/*
    ...
    */
    ...
    public void updateEnemyHp(int hp) {
        ...
        labelEnemyHP = ("" + board.getEnemy().getHp());
    }
    ...
    public void updateUI() {
        labelEnemyCAP = (String.valueOf(Board.MAX_CAP_POINTS - enemyField.getCapPoints()));
        labelPlayerCAP = (String.valueOf(Board.MAX_CAP_POINTS - playerField.getCapPoints()));

        labelEnemyHP = (String.valueOf(board.getEnemy().getHp()));     // Only useful when the player hasn't attacked the enemy yet.
        labelPlayerHP = (String.valueOf(board.getPlayer().getHp()));   // Only useful when the player hasn't attacked the enemy yet.
    ...
    public void initialize(URL location, ResourceBundle resources) {
        ...
        playerField = new FieldGrid(847, 253, 2, 6, new BoardController(), FieldType.Player);
        enemyField = new FieldGrid(847, 253, 2, 6, new BoardController(), FieldType.Enemy);
    ...
    public void UpdatePlayerDeckCount(int amount) {
        ...
        labelPlayerDeckSize = (String.valueOf(amount));
    }
    ...
    public void updateEnemyDeckCount(int amount) {
        ...
        labelEnemyDeckSize = (String.valueOf(amount));
    }
